...
void GeometryViewer::load_shaders(){
	...
	if (m_programID)
		glDeleteProgram(m_programID);
	std::string shader_vs = R"(B:\Workspace\FrameWork\Geometry3DViewer\Shaders\vertexcolor_vs.glsl)";
	std::string shader_fs = R"(B:\Workspace\FrameWork\Geometry3DViewer\Shaders\vertexcolor_fs.glsl)";
